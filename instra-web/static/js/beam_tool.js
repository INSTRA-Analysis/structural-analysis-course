...
function BeamDiagram({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    height: 40,
    fill: "#C0392B14"
  }), B < L && /*#__PURE__*/React.createElement("rect", {
    x: xB,
    y: 60,
    width: padL + beamW - xB,
    height: 40,
    ...
    stroke: C.amber,
    strokeWidth: "1.5"
  }), udlArrows, /*#__PURE__*/React.createElement("text", {
    x: padL + beamW / 2,
    y: beamY - 34,
    textAnchor: "middle",
    fill: C.amber,
    ...
    fill: C.red,
    fontSize: "11"
  }, P, " kN")), /*#__PURE__*/React.createElement("polygon", {
    points: `${xA},${beamY + 5} ${xA - 7},${beamY + 21} ${xA + 7},${beamY + 21}`,
    fill: C.teal
  }), /*#__PURE__*/React.createElement("text", {
    x: xA,
    y: beamY + 34,
    ...
    fill: C.textMuted,
    fontSize: "10"
  }, "A (", fmt(A, 1), " m)"), /*#__PURE__*/React.createElement("polygon", {
    points: `${xB},${beamY + 5} ${xB - 7},${beamY + 21} ${xB + 7},${beamY + 21}`,
    fill: "none",
    stroke: C.teal,
    strokeWidth: "1.5"
    ...
    fill: C.textMuted,
    fontSize: "10"
  }, "B (", fmt(B, 1), " m)"), /*#__PURE__*/React.createElement("text", {
    x: padL + beamW / 2,
    y: H - 6,
    textAnchor: "middle",
    fill: C.textMuted,
...
function SliderRow({
  ...
  }, fmt(value, 1), " ", unit)), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: min,
    max: max,
    step: step,
...
function OptimiseTab({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(SectionHead, null, "Optimise the section (most economical)"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: C.textMuted,
      fontSize: 13,
      marginBottom: 12
    ...
    label: "Allowable bending stress σ_allow",
    value: sigAllow,
    unit: "MPa",
    min: 50,
    max: 400,
    step: 5,
    onChange: setSigAllow
  }), /*#__PURE__*/React.createElement(SliderRow, {
    label: "Current section modulus Z",
    value: Zsec,
    unit: "cm³",
    min: 50,
    max: 5000,
    ...
    style: {
      ...btnPrimary,
      ...(!pyReady || busy ? disabledBtn : {})
    },
    disabled: !pyReady || busy,
    onClick: run
  }, busy ? "Sizing…" : "Size the section"), err && /*#__PURE__*/React.createElement("p", {
    style: {
      color: C.red,
      fontSize: 13,
      marginTop: 12
    ...
    label: "Required I (min)",
    value: fmt(res.I_req, 0),
    unit: "cm⁴",
    color: C.teal
  }), /*#__PURE__*/React.createElement(StatCard, {
    label: "Current I",
    value: fmt(res.I_cur, 0),
    unit: "cm⁴",
    color: C.blue
  }), /*#__PURE__*/React.createElement(StatCard, {
    label: "Current δmax",
    value: fmt(res.dmax_cur, 2),
    unit: `mm (limit ${fmt(res.dlim, 0)})`,
    color: C.amber
  }), /*#__PURE__*/React.createElement(StatCard, {
    label: "Utilisation",
    value: fmt(res.util_def * 100, 0),
    unit: "% of limit",
    color: res.pass_def ? C.teal : C.red
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: C.textMuted,
  ...
  }, "STRENGTH — bending stress (Mmax = ", fmt(res.Mmax, 1), " kN·m)"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 12,
      flexWrap: "wrap"
    ...
    label: "Required Z (min)",
    value: fmt(res.Z_req, 0),
    unit: "cm³",
    color: C.teal
  }), /*#__PURE__*/React.createElement(StatCard, {
    label: "Current Z",
    value: fmt(res.Z_cur, 0),
    unit: "cm³",
    color: C.blue
  }), /*#__PURE__*/React.createElement(StatCard, {
    label: "σmax",
    value: fmt(res.sigma_max, 1),
    unit: `MPa (allow ${fmt(res.sig_allow, 0)})`,
    color: C.amber
  }), /*#__PURE__*/React.createElement(StatCard, {
    label: "Utilisation",
    value: fmt(res.util_str * 100, 0),
    unit: "% of allow",
    color: res.pass_str ? C.teal : C.red
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 12,
    ...
    label: "Governing limit state",
    value: res.governs === "deflection" ? "Deflection" : "Strength",
    unit: "",
    color: C.amber
  }), /*#__PURE__*/React.createElement(StatCard, {
    label: "Overall verdict",
    value: res.passes ? "PASS" : "FAIL",
    unit: "",
  ...
  }, "The economical section is the smallest one meeting ", /*#__PURE__*/React.createElement("strong", null, "both"), " limits:", " ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: C.teal
    }
  }, "I ≥ ", fmt(res.I_req, 0), " cm⁴"), " and", " ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: C.teal
    }
  }, "Z ≥ ", fmt(res.Z_req, 0), " cm³"), ".", " ", /*#__PURE__*/React.createElement("strong", {
    style: {
...
function PracticeTab({
  ...
  const lastErr = res && res.err ? res.err.trim().split("\n").filter(l => l.trim()).pop() : null;
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(SectionHead, null, "Practice — write & run Python"), /*#__PURE__*/React.createElement("div", {
    style: {
      background: C.navy,
      border: `1px solid ${C.navyBorder}`,
      borderRadius: 8,
  ...
  }, "New to Python? You're in the right place. Work through the steps left to right — they get a little deeper each time. Replace each ", /*#__PURE__*/React.createElement("code", null, "___"), " blank, press", " ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: C.amber
    }
  }, "▶ Run my code"), ", and read what comes back. Stuck or curious? ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: C.teal
    }
  }, "💡 Show solution"), " is always there — reading worked code is part of learning, not cheating. Nothing you type can break anything, so experiment freely."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      flexWrap: "wrap",
  ...
  }, EXERCISES.map((e, i) => /*#__PURE__*/React.createElement("button", {
    key: e.id,
    onClick: () => pick(i),
    style: {
  ...
  }, ex.expected)), variants && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 0,
      marginBottom: 10,
    ...
    disabled: !pyReady || busy,
    onClick: run
  }, busy ? "Running…" : "▶ Run my code"), /*#__PURE__*/React.createElement("button", {
    style: btnGhost,
    onClick: () => setCode(activeStarter)
  ...
  }, "Error: ", lastErr), /*#__PURE__*/React.createElement("details", {
    style: {
      marginTop: 6
    }
  ...
  })), !res.out && res.figs.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      color: C.amber,
      fontSize: 13
    }
...
function BeamAnalysisTool() {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "InstraHub · Course Tool"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 17,
      fontWeight: 700
    }
  }, "Simply Supported Beam Analysis")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8,
  ...
  }, "Length"))), /*#__PURE__*/React.createElement("tbody", {
    style: {
      color: C.textCode
    }
  }, [["Left cantilever", segLeft], ["Interior span", segSpan], ["Right cantilever", segRight]].map(([n, v]) => /*#__PURE__*/React.createElement("tr", {
    key: n,
    style: {
      borderBottom: `1px solid ${C.navyBorder}`
    }
    ...
    step: 1,
    onChange: setW
  }), /*#__PURE__*/React.createElement(SectionHead, null, "Section (for deflection)"), /*#__PURE__*/React.createElement(SliderRow, {
  ...
  }, "← Geometry"), /*#__PURE__*/React.createElement("button", {
    style: btnPrimary,
    onClick: () => {
      setTab("results");
      runAnalysis();
    ...
    onClick: runAnalysis
  }, running ? "Running…" : stats ? "↺ Re-run" : "Run Analysis"), err && /*#__PURE__*/React.createElement("p", {
    style: {
      color: C.red,
      fontSize: 13,
      marginTop: 12
    }
  }, err), stats && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 12,
      flexWrap: "wrap",
    ...
    label: "|M|max",
    value: fmt(stats.Mmax),
    unit: "kN·m",
    color: C.blue
  }), /*#__PURE__*/React.createElement(StatCard, {
    label: "|V|max",
    value: fmt(stats.Vmax),
    unit: "kN",
    color: C.blue
  }), /*#__PURE__*/React.createElement(StatCard, {
    label: "δmax",
  ...
  }, [["L", `${fmt(L, 1)} m`], ["Pin A", `${fmt(A, 1)} m`], ["Roller B", `${fmt(B, 1)} m`], ["Point load P", `${P} kN @ ${fmt(xP, 1)} m`], ["UDL w", `${w} kN/m`], ["E", `${E} GPa`], ["I", `${I} cm⁴`]].map(([k, v]) => /*#__PURE__*/React.createElement("tr", {
    key: k,
    style: {
      borderBottom: `1px solid ${C.navyBorder}`
    }
  ...
  }, "⬇ Download .ipynb"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 18
    }
  }, /*#__PURE__*/React.createElement("button", {
...
/* ── Mount ───────────────────────────────────────────────────────────────── */
ReactDOM.createRoot(document.getElementById("beam-tool-root")).render(/*#__PURE__*/React.createElement(BeamAnalysisTool, null));
